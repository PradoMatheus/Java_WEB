...
<form method="post" action="order">
    <div class="container mt-5">
        ...
        <div class="form-group row m-1">
            ...
            <div class="col-sm-10">
                <select class="form-select" id="selClient">
        ...
        <div class="form-group row m-1">
            ...
            <div class="col-sm-5">
                <select class="form-select" id="selProduct">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control text-center" id="txtPrice" value="R$ 00,00" readonly>
            </div>
            <label class="col-sm-1 col-form-label" for="txtQuantity">Quantidade:</label>
            <div class="col-sm-1">
                <input type="text" class="form-control text-center" id="txtQuantity">
            </div>
        </div>
        <div class="form-group row m-1">
            ...
            <div class="col-sm-2">
                <input type="text" readonly class="form-control" id="txtTotalValue">
            </div>
        </div>
